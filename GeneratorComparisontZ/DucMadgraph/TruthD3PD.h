...
// Mon Jun 16 12:00:29 2014 by ROOT version 5.34/03
// from TTree LHEF/Analysis tree
// found on file: NTUP.schan.LHE.root
//////////////////////////////////////////////////////////
...
#ifdef TruthD3PD_cxx
TruthD3PD::TruthD3PD(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("NTUP.schan.LHE.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("NTUP.schan.LHE.root");
      }
...
Int_t TruthD3PD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TruthD3PD::LoadTree(Long64_t entry)
{
...
void TruthD3PD::Init(TTree *tree)
{
...
void TruthD3PD::Show(Long64_t entry)
{
...
Int_t TruthD3PD::Cut(Long64_t entry)
{
