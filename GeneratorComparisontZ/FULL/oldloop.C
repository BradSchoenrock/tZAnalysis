...
void loop()
{
  ...
  TH1F *LeadJetPT=new TH1F("LeadJetPT","LeadJet PT",20,0,400);
  TH1F *LeadJetEta=new TH1F("LeadJetEta","LeadJet Eta",20,-5,5);
  TH1F *LeadJetphi=new TH1F("LeadJetphi","LeadJet phi",16,-4,4);
  TH1F *LeadJetmass=new TH1F("LeadJetmass","LeadJet mass",100,0,50);

  TH1F *SecondJetPT=new TH1F("SecondJetPT","SecondJet PT",20,0,400);
  TH1F *SecondJetEta=new TH1F("SecondJetEta","SecondJet Eta",20,-5,5);
  TH1F *SecondJetphi=new TH1F("SecondJetphi","SecondJet phi",16,-4,4);
  TH1F *SecondJetmass=new TH1F("SecondJetmass","SecondJet mass",100,0,50);

  TH1F *MET_PT=new TH1F("recovPT","MET PT",12,0,240);
  TH1F *MET_Eta=new TH1F("recovEta","MET Eta",20,-5,5);
  TH1F *MET_phi=new TH1F("recovphi","MET phi",16,-4,4);
  TH1F *MET_pz=new TH1F("recovpz","MET pz",24,-240,240);
  ...
  TH1F *recoWPT=new TH1F("recoWPT","recoW PT",20,0,400);
  ...
  TH1F *recotopPT=new TH1F("recotopPT","recotop PT",20,0,400);
  TH1F *recotopEta=new TH1F("recotopEta","recotop Eta",20,-5,5);
  TH1F *recotopphi=new TH1F("recotopphi","recotop phi",16,-4,4);
  TH1F *recotopmass=new TH1F("recotopmass","recotop mass",15,100,250);

  TH1F *recoZPT=new TH1F("recoZPT","recoZ PT",20,0,400);
  TH1F *recoZEta=new TH1F("recoZEta","recoZ Eta",20,-5,5);
  TH1F *recoZphi=new TH1F("recoZphi","recoZ phi",16,-4,4);
  TH1F *recoZmass=new TH1F("recoZmass","recoZ mass",30,70,110);
