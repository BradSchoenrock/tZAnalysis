...
// Mon Jun  9 10:48:40 2014 by ROOT version 5.34/03
// from TTree LHCO/Analysis tree
// found on file: tag_1_pgs_events.root
//////////////////////////////////////////////////////////
...
const Int_t kMaxTau = 2;
const Int_t kMaxJet = 9;
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("tag_1_pgs_events.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("tag_1_pgs_events.root");
      }
